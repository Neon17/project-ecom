...
<div class="delete-modal hidden fixed top-0 left-1/3 w-1/3 p-3 bg-green-100">
    ...
    <div class="action-wrapper flex justify-center">
        <button
            class="close-delete-modal p-2 bg-gray-500 text-white mx-2 rounded transition-all duration-300 hover:bg-gray-700 hover:cursor-pointer">Cancel</button>
