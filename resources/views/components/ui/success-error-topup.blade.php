@if (session('success') || session('error'))
    <div id="flash-message"
        class="fixed top-4 right-4 z-75 w-96 
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                <h3 class="font-semibold 
                           ...
                           {{ session('success') ? 'text-green-900 dark:text-green-300' : 'text-red-900 dark:text-red-300' }}">
            ...
            <button onclick="closeFlashMessage()" 
                class="flex-shrink-0 text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:hover:text-gray-100">
