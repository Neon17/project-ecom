                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    @if ($addresses->count() > 0)
                        <div class="mb-6 p-4 border border-blue-200 rounded-lg">
                            ...
                            <p class="text-xs text-gray-500 mt-3">Or enter a new address below</p>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('carts.checkout', $cart->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label for="street_address_1" class="block text-sm font-medium text-gray-700 mb-1">
                                    Street Address
                                </label>
                            ...
                            <!-- Street Address 2 -->
                            <div class="md:col-span-2">
                                <label for="street_address_2" class="block text-sm font-medium text-gray-700 mb-1">
