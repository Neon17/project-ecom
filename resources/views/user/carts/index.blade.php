<x-layouts.user>
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8" x-data="guestCartPage({{ auth()->check() ? 'true' : 'false' }}, {{ $cart ? $cart->cartItems->toJson() : '[]' }})">
        <div class="max-w-7xl mx-auto">
            ...
            <template x-if="items.length > 0">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <div class="flex-1">
                                            ...
                                            <div>
                                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-1">
                                                    <a :href="'/products/' + (item.product_id || item.id)"
                                                        ...
                                                        x-text="item.name || item.product.name">
                                                    </a>
                                                </h3>
                                                <p class="text-gray-600 dark:text-gray-300 text-sm line-clamp-2"
                                                    x-text="item.description || (item.product ? item.product.description : '')">
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="font-semibold text-gray-900 dark:text-white ml-2">NPR
                                                        <span
                                                            x-text="formatPrice(item.price || item.product.price)"></span></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-right">
                                                ...
                                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">NPR
                                                    <span
                                                        x-text="formatPrice((item.price || item.product.price) * item.quantity)"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex gap-3 mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                            ...
                                            <template x-if="isLoggedIn">
                                                <form :action="'/user/cart-items/' + item.id" method="POST"
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 sticky top-24">
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
                                <svg class="h-6 w-6 mr-2 text-blue-600 dark:text-blue-400" fill="none"
                            ...
                            <div class="space-y-4 mb-6">
                                ...
                                <div class="flex justify-between text-gray-600 dark:text-gray-300">
                                    <span>Subtotal:</span>
                                    <span class="font-semibold">NPR <span
                                            x-text="formatPrice(grandTotal)"></span></span>
                                </div>
                                <div class="flex justify-between text-gray-600 dark:text-gray-300">
                                    <span>Shipping:</span>
                            ...
                            <div class="border-t border-gray-200 dark:border-slate-700 pt-4 mb-6">
                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-semibold text-gray-900 dark:text-white">Grand
                                        Total:</span>
                                    <span class="text-3xl font-bold text-blue-600 dark:text-blue-400">NPR <span
                                            x-text="formatPrice(grandTotal)"></span></span>
                                </div>
                            </div>
            ...
            <template x-if="items.length === 0">
                <!-- Empty Cart State -->
                <div
                    class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-12 text-center">
                    <div class="max-w-md mx-auto">
                        <div class="text-8xl mb-6">🛒</div>
                        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-3">Your cart is empty</h2>
                        <p class="text-gray-600 dark:text-gray-300 mb-8 text-lg">Looks like you haven't added anything
                            to your cart yet. Start exploring our amazing products!</p>
                        <a href="{{ route('products.index') }}"
