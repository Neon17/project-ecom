            ...
            <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                        ...
                        <form action="{{ route('products.index') }}" method="GET">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="space-y-2 max-h-48 overflow-y-auto">
                                    <div class="flex items-center">
                                        ...
                                        <label for="cat_all" class="ml-2 text-sm text-gray-600">All Categories</label>
                                    </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <a href="{{ route('products.index') }}" class="w-full text-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
                                    Reset
                                </a>
                            </div>
                        </form>
                ...
                <div class="flex-1">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-500">Showing {{ $products->firstItem() ?? 0 }} - {{ $products->lastItem() ?? 0 }} of {{ $products->total() }} results</p>
                    </div>
                                    ...
                                    <div class="p-5 flex flex-col flex-1">
                                        <div class="mb-2">
                                            @foreach($product->categories->take(2) as $cat)
                                                <span class="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full mr-1">
                                                    {{ $cat->name }}
                                                </span>
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                                            ...
                                            <form action="{{ route('user.cart.store') }}" method="POST">
                                                ...
                                                <button type="submit" class="p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-blue-600 hover:text-white transition-colors" title="Add to Cart" {{ $product->quantity <= 0 ? 'disabled' : '' }}>
