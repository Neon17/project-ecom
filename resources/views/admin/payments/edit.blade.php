    ...
    <div class="max-w-2xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('admin.payments.update', $payment->id) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="p-2 bg-gray-100 border border-gray-300 rounded text-gray-700">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('admin.payments.index') }}" 
                   class="bg-gray-500 text-white px-6 py-3 rounded hover:bg-gray-600 transition duration-200">
                    Cancel
                </a>
                <button type="submit" 
