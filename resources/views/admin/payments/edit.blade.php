<x-layouts.admin>
    <div class="max-w-2xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Payment #{{ $payment->id }}</h1>
        </div>
        ...
        <form action="{{ route('admin.payments.update', $payment->id) }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-1">Order</label>
                        <div class="p-2 bg-gray-50 dark:bg-slate-800 border border-gray-300 dark:border-gray-600 rounded-md text-gray-800 dark:text-gray-200 text-sm">
            ...
            <div class="flex justify-end space-x-3 pt-2">
                <a href="{{ route('admin.payments.index') }}"
                   class="px-4 py-2 bg-gray-300 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-400 font-medium">
                    Cancel
                </a>
                <button type="submit"
