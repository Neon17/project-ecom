        ...
        <div class="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50 dark:bg-slate-800">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">ID</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">User</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">Items</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">Total Value</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase">Created</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($carts as $cart)
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-800">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{{ $cart->user->email }}</div>
                                    </td>
            ...
            @else
                <div class="text-center py-12 bg-gray-50 dark:bg-slate-800 rounded-lg">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">No users have items in their carts yet.</p>
                </div>
            @endif
        </div>
    </div>
