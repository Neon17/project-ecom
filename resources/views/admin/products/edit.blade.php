        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Edit Product #{{ $product->id }}</h1>
                        <p class="text-gray-600 mt-2">Update product details for your store</p>
                    </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        @error('image')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 mt-1">Leave empty to keep current image. Accepted formats: JPEG, PNG, JPG, GIF, SVG (Max: 2MB)</p>
