        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Product #{{ $product->id }}</h1>
                        <p class="text-gray-600 dark:text-gray-300 dark:text-gray-600 mt-2">Update product details for your store</p>
                    </div>
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <!-- Slug -->
                    <div>
                        <label for="slug" class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">
                        ...
                        @else
                            <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                                <p class="text-sm text-yellow-800">
                                    ...
                                    <a href="#" class="font-medium underline hover:text-yellow-900">Create categories first</a>
                                </p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div>
                        ...
                        @if($product->image)
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Current Image</label>
                                <img src="{{ $product->image_url }}" 
                                     alt="{{ $product->name }}" 
                                     class="max-w-xs h-auto rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm">
                            </div>
                        @endif
                        ...
                        @error('image')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">Leave empty to keep current image. Accepted formats: JPEG, PNG, JPG, GIF, SVG (Max: 2MB)</p>
                        
                        <!-- Image Preview -->
                        <div id="imagePreview" class="mt-4 hidden">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">New Image Preview</label>
