<x-layouts.admin>
    ...
    <div class="max-w-xl mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-gray-100 dark:bg-slate-800 min-h-screen rounded-lg shadow-md mt-8">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white dark:bg-slate-900 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 p-8 space-y-6">
            @csrf
            
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-6 pb-4 border-b border-gray-200 dark:border-slate-700">User Details</h2>
            ...
            <!-- Password -->
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">Password <span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <select name="role" id="role" required
                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 appearance-none bg-white dark:bg-slate-900 pr-8">
